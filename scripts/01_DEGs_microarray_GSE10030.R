...
dir.create("results/GSE10030", showWarnings = FALSE, recursive = TRUE)
dir.create("figures/GSE10030", showWarnings = FALSE, recursive = TRUE)
...
group <- factor(c(
  rep("Biofilm_Untreated",3),
  rep("Biofilm_Tobramycin",3),
  rep("Planktonic_Untreated",2),
  rep("Planktonic_Tobramycin",2)
))
...
group_colors <- c(
  rep("#56B4E9", 3),  # Biofilm_Untreated
  rep("#E69F00", 3),  # Biofilm_Tobramycin
  rep("#009E73", 2),  # Planktonic_Untreated
  rep("#CC79A7", 2)   # Planktonic_Tobramycin
)
...
png(
  "figures/GSE10030/RMA_normalized_expression_boxplot_GSE10030.png",
  width = 1200,
  height = 900,
  res = 150
)
...
svg(
  "figures/GSE10030/RMA_normalized_expression_boxplot_GSE10030.svg",
  width = 10.67,
  height = 7.33
)
...
boxplot(
  ...
  border = "grey30",
  outline = FALSE,
  main = "RMA-normalized expression distribution (GSE10030)",
...
legend(
  ...
  legend = c(
    "Biofilm Untreated",
    "Biofilm Tobramycin",
    "Planktonic Untreated",
    "Planktonic Tobramycin"
  ),
  fill = c(
    "#56B4E9",
    "#E69F00",
...
write.csv(
  expr,
  "results/GSE10030/GSE10030_RMA_expression.csv"
)
...
p <- ggplot(pca_df,
  ...
  geom_point(size = 3) +
  labs(
    title = "RMA normalized expression PCA - GSE10030",
...
ggsave(
  "figures/GSE10030/PCA_GSE10030.png",
  plot = p,
  width = 8,
  height = 6
)
...
pheatmap(
  ...
  main = "Sample-to-Sample Distance - GSE10030",
  filename = "figures/GSE10030/Sample_distance_heatmap_GSE10030.png",
  width = 6,
  height = 5,
  fontsize = 8,       
  fontsize_row = 7,    
...
contrast.matrix <- makeContrasts(
  Biofilm_Tobramycin_vs_Control =
    Biofilm_Tobramycin - Biofilm_Untreated,
...
write.csv(
  deg_sorted,
  "results/GSE10030/GSE10030_DEGs.csv"
)
...
write.csv(
  deg_final,
  "results/GSE10030/GSE10030_DEGs_Annotated.csv",
  row.names = FALSE
)
...
write.csv(deg_sig, "results/GSE10030/GSE10030_significant.csv")
...
write.csv(
  up_genes,
  "results/GSE10030/GSE10030_upregulated.csv",
  row.names = FALSE
)

write.csv(
  down_genes,
  "results/GSE10030/GSE10030_downregulated.csv",
  row.names = FALSE
)
...
(
  ...
  title =
    "Tobramycin-treated biofilm vs Control biofilm (GSE10030)",
...
ggsave(
  "figures/GSE10030/Volcano_plot_GSE10030.png",
...
ggsave(
  "figures/GSE10030/MA_plot_GSE10030.png",
  plot = p_ma,
  width = 8,
  height = 6,
  dpi = 300
