...
contrast.matrix <- makeContrasts(
  Tobramycin_vs_Control =
    Tobramycin_Treatment - Control,
...
write.csv(
  deg_sorted,
  "results/GSE65870/GSE65870_DEGs_Tobramycin_vs_Control.csv"
)
...
write.csv(
  deg_final,
  "results/GSE65870/GSE65870_DEGs_Annotated_Tobramycin_vs_Control.csv",
  row.names = FALSE
)
...
write.csv(deg_sig, "results/GSE65870/GSE65870_significant_Tobramycin_vs_Control.csv")
...
write.csv(
  up_genes,
  "results/GSE65870/GSE65870_upregulated_Tobramycin_vs_Control.csv",
  row.names = FALSE
)

write.csv(
  down_genes,
  "results/GSE65870/GSE65870_downregulated_Tobramycin_vs_Control.csv",
  row.names = FALSE
)
...
(
  ...
  title =
    "Tobramycin-treated biofilm vs Control biofilm (GSE65870)",
...
ggsave(
  "figures/GSE65870/Volcano_plot_GSE65870_Tobramycin_vs_Control.png",
...
ggsave(
  "figures/GSE65870/MA_plot_GSE65870_Tobramycin_vs_Control.png",
  plot = p_ma,
  width = 8,
  height = 6,
  dpi = 300
